<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Document Package</h2>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('document-packages.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" required
                                       value="{{ old('name') }}"
                                       placeholder="e.g. Q1 2024 Investor Documents"
                                ...
                                <select name="notify_user_id" id="notify_user_id"
                                    ...
                                    @foreach($notifiableUsers as $user)
                                        <option value="{{ $user->id }}"
                                            {{ old('notify_user_id') == $user->id ? 'selected' : '' }}>
