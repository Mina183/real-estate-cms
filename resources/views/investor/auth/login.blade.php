...
<body class="bg-gray-50">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <!-- Login Form -->
            <form class="mt-8 space-y-6" action="{{ $formAction ?? route('investor.login') }}" method="POST">
                @csrf
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            required
                            class="appearance-none rounded-none relative block w-full px-3 py-2 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm @error('password') border-red-500 @enderror"
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('investor.password.request') }}" class="font-medium text-blue-600 hover:text-blue-500">
