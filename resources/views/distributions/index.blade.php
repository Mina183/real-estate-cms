    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-4 mb-5">
                <form method="GET" action="{{ route('distributions.index') }}" class="flex flex-wrap gap-3 items-end">
                    <div class="flex-1 min-w-48">
                        <label class="block text-xs font-medium text-gray-500 mb-1">Search</label>
                        <input type="text" name="search" value="{{ request('search') }}"
                               placeholder="Title or distribution number…"
                    ...
                    <div class="min-w-40">
                        ...
                        <select name="type" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500">
                            ...
                            @foreach(['dividend','return_of_capital','profit_share','other'] as $t)
                    ...
                    <div class="flex gap-2">
                        ...
                        @if(request()->hasAny(['search','status','type']))
                            <a href="{{ route('distributions.index') }}" class="px-4 py-2 bg-gray-100 text-gray-600 text-sm font-semibold rounded-md hover:bg-gray-200 transition">Clear</a>
                        @endif
                    </div>
                </form>
            </div>
