<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('capital-calls.store') }}" method="POST">
                @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="description" id="description" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-dark focus:ring-brand-dark"
                                    placeholder="Purpose and details of this capital call">{{ old('description') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Draft allows editing before issuing to investors</p>
                            </div>

                            {{-- Call Date --}}
                            <div>
                                <label for="call_date" class="block text-sm font-medium text-gray-700">Call Date *</label>
                                <input type="date" name="call_date" id="call_date" value="{{ old('call_date', date('Y-m-d')) }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-dark focus:ring-brand-dark">
                            </div>
                    ...
                    <div class="p-6">
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Commitment</th>
                                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Funded</th>
                                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Call Amount</th>
                                        </tr>
                                    </thead>
                                        ...
                                        @foreach($investors as $investor)
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600">
                                                    ${{ number_format($investor->final_commitment_amount, 0) }}
                                                </td>
                                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600">
                        ...
                        @else
                            <div class="text-center py-8 text-gray-500">
                                No active investors found. <a href="{{ route('investors.index') }}" class="text-brand-dark hover:underline">Add investors</a> first.
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('capital-calls.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-6 rounded">
                        Cancel
                    </a>
